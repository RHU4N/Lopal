...
function multiplicacaoAcumulada() {
  let mult = 1;
  for (let i = 1; i <= 5; i++) {
    mult *= i; // mult = mult * i
  }
...
function divisiveisPor5() {
  ...
  console.log(
    `A quantidade de numeros divisiveis por 5 de 1 a 100 é: ${count}`
  );
}

// 12. quadrados dos numeros
function quadradosDosNumeros() {
  for (let i = 1; i <= 10; i++) {
